var rule = {
	...
	class_name: '☁️云随缘4k蓝光电视剧&☁️云随缘4k蓝光电影&☁️云随缘4k蓝光综艺&☁️云随缘4k蓝光动漫&☁️云随缘4k蓝光少儿&☁️云随缘4k蓝光纪录片',
...
if (/\.m3u8$/.test(input)) {
    ...
    let kurl = 'http://json.84jia.top/home/api?type=ys&uid=255327&key=hinruzBDJKMNP01268&url=' + encodeURIComponent(input);
...
`,
	...
	二级: $js.toString(() => {
		...
		VOD.vod_play_from = yg.length < 1 ? "想要看4k画质，就选📺极视云4k📺" : "不用扫码授权看4k画质,就选📺极视云4k📺不限次数观看$$$4k 预告及花絮";
